...
These instructions will help you get the project up and running locally for development and testing.

You’ll need [Git](https://git-scm.com) and [Node.js](https://nodejs.org/en/download/) installed. Alternatively, you can use [Docker](https://www.docker.com/products/docker-desktop).
